    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        $(".messenger-infoView")
          ...
          'url("' +'http://127.0.0.1:8000/storage/users-avatar/'+lastSection + '")');
        // $(".header-avatar").css(
        //   "background-image",
        //   'url("' + data.user_image + '")'
        // );
         $(".header-avatar").css(
          "background-image",
          'url("' +'http://127.0.0.1:8000/storage/users-avatar/'+lastSection + '")'
             //'url("http://127.0.0.1:8000/storage/users-avatar/0623a8e9-a8b0-47a0-abdb-6a80f116bb2f.jpg")'
        );
        // $(".user-image").css("background-image", function() {
        //   return 'url("' + '{{asset("storage/uploads")}}/' + '{{ auth()->user()->user_image}}' + '")';
        // });
        ...
        // var authUserName = $(".m-header-messaging .user-name").text();
        // Star status
        data.favorite > 0
